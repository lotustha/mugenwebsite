...
export default function Home() {
  return (
    <main className="w-full flex-col flex overflow-hidden">
      ...
      <section className="relative pt-40 pb-20 px-6 min-h-screen flex items-center justify-center">
        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center z-10">
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left gap-8 w-full">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[var(--surface-container-low)] ghost-border">
              <span className="w-2 h-2 rounded-full bg-[var(--tertiary)] animate-pulse"></span>
              <span className="text-xs font-semibold text-[var(--on-surface-variant)] uppercase tracking-wider">The Kinetic Canvas is Here</span>
            </div>
            ...
            <p className="text-lg md:text-xl text-[var(--on-surface-variant)] leading-relaxed max-w-xl">
            ...
            <div className="flex flex-wrap items-center gap-4 mt-4">
              <button className="flex items-center gap-2 bg-gradient-to-br from-[var(--primary)] to-[var(--primary-container)] text-[var(--on-primary)] px-8 py-4 rounded-lg font-bold text-base hover:brightness-110 active:scale-95 transition-all shadow-[0_0_30px_rgba(186,158,255,0.3)]">
          ...
          <div className="relative w-full h-[600px] md:h-[700px] flex items-center justify-center z-20 mt-8 lg:mt-0 perspective-1000">
            <div className="relative w-[280px] md:w-[320px] animate-float ambient-shadow transition-transform duration-700 hover:scale-105">
              <div className="absolute inset-x-0 -bottom-10 h-32 bg-gradient-to-t from-[var(--surface)] to-transparent z-30 pointer-events-none blur-[10px] opacity-70"></div>
      ...
      <section className="relative py-32 mt-20 px-6 bg-[var(--surface-container-lowest)] overflow-hidden">
        {/* Gradient Transition from prev section */}
        <div className="absolute inset-x-0 top-0 h-40 bg-gradient-to-b from-[var(--surface)] to-transparent z-10 pointer-events-none"></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[1200px] h-[500px] bg-[var(--primary)]/10 blur-[150px] rounded-full pointer-events-none z-0"></div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col items-center gap-16 relative z-20">
          <div className="text-center max-w-3xl flex flex-col items-center gap-6">
            ...
            <p className="text-[var(--on-surface-variant)] text-lg leading-relaxed max-w-xl">
          ...
          <div className="w-full max-w-4xl relative group">
            ...
            <div className="absolute -inset-10 bg-gradient-to-r from-[var(--primary)]/20 to-[var(--tertiary)]/20 rounded-3xl blur-[60px] opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
        ...
        <div className="absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-[var(--surface-container-low)] to-transparent z-10 pointer-events-none"></div>
      </section>

      {/* Feature 1: Immersive Details */}
      <section id="features" className="relative py-24 md:py-32 px-6 bg-[var(--surface-container-low)]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-24 items-center">
          <div className="order-2 md:order-1 flex justify-center w-full">
            <div className="w-[280px] md:w-[340px] relative animate-float">
              <div className="absolute -inset-10 bg-[var(--primary)]/5 rounded-full blur-[80px]"></div>
          ...
          <div className="order-1 md:order-2 flex flex-col items-start gap-6 w-full lg:max-w-md">
            <h2 className="font-epilogue text-4xl md:text-6xl font-extrabold tracking-tight">
              Cinematic <br/><span className="text-[var(--on-surface-variant)]">Immersion.</span>
            </h2>
            ...
            <ul className="mt-6 flex flex-col gap-4">
              <li className="flex items-start gap-4">
                <div className="w-8 h-8 rounded-full bg-[var(--surface-container-highest)] flex items-center justify-center shrink-0">
                  <Play className="w-4 h-4 text-[var(--primary)]" />
                </div>
                <div>
                  <h4 className="font-bold text-white">Ghost Borders</h4>
                  <p className="text-sm text-[var(--on-surface-variant)] mt-1">Containers implied by subtle 15% opacity shifts, never harsh lines.</p>
                </div>
              </li>
              <li className="flex items-start gap-4">
                <div className="w-8 h-8 rounded-full bg-[var(--surface-container-highest)] flex items-center justify-center shrink-0">
                  <Heart className="w-4 h-4 text-[var(--tertiary)]" />
                </div>
                <div>
                  <h4 className="font-bold text-white">Episode Pulse</h4>
                  <p className="text-sm text-[var(--on-surface-variant)] mt-1">Vibrant tertiary progress indicators cut through the abyss.</p>
                </div>
              </li>
            </ul>
          </div>
      ...
      <section id="discover" className="relative py-32 md:py-48 px-6 bg-[var(--surface)] overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center gap-6 mb-20 z-10 relative">
          ...
          <p className="text-[var(--on-surface-variant)] text-lg max-w-xl">
        ...
        <div className="max-w-6xl mx-auto w-full relative h-[600px] md:h-[700px] flex justify-center items-center">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[800px] aspect-square bg-[var(--primary)]/5 rounded-full blur-[100px] pointer-events-none animate-pulse-glow"></div>
          ...
          <div className="absolute z-20 w-[200px] md:w-[260px] translate-x-[-70%] md:translate-x-[-90%] translate-y-[10%] rotate-[-4deg] opacity-70 hover:opacity-100 hover:rotate-0 hover:z-40 transition-all duration-500 animate-float-delayed">
            ...
            <div className="absolute -bottom-16 left-1/2 -translate-x-1/2 flex items-center gap-2">
              <Heart className="w-5 h-5 text-[var(--tertiary)]" /> <span className="font-bold tracking-wide text-sm whitespace-nowrap">Your List</span>
            </div>
          </div>
          ...
          <div className="absolute z-20 w-[200px] md:w-[260px] translate-x-[70%] md:translate-x-[90%] translate-y-[5%] rotate-[4deg] opacity-70 hover:opacity-100 hover:rotate-0 hover:z-40 transition-all duration-500 animate-float" style={{ animationDelay: '1.5s' }}>
            ...
            <div className="absolute -bottom-16 left-1/2 -translate-x-1/2 flex items-center gap-2">
              <Calendar className="w-5 h-5 text-[var(--primary)]" /> <span className="font-bold tracking-wide text-sm whitespace-nowrap">Schedule</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="download" className="relative py-24 px-6 mt-12 bg-gradient-to-b from-[var(--surface)] to-[var(--surface-container-lowest)]">
        <div className="max-w-5xl mx-auto glass-panel p-8 md:p-16 rounded-[2rem] md:rounded-[3rem] ghost-border flex flex-col md:flex-row items-center gap-12 relative overflow-hidden">
          <div className="absolute -top-40 -right-40 w-[300px] h-[300px] bg-[var(--primary-container)]/20 rounded-full blur-[80px]"></div>
          ...
          <div className="w-[200px] md:w-[260px] shrink-0 z-10 relative animate-float-delayed">
            ...
            <div className="absolute top-10 -right-6 md:-right-10 bg-[var(--surface-container-high)] ghost-border px-4 py-3 rounded-2xl ambient-shadow flex items-center gap-3 animate-bounce shadow-[0_10px_30px_rgba(0,0,0,0.5)]" style={{ animationDuration: '3s' }}>
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[var(--primary)] text-xs font-medium border border-[var(--primary)]/30 rounded px-1 w-fit mt-0.5">1080p</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left gap-6 z-10">
            ...
            <p className="text-[var(--on-surface-variant)] text-lg max-w-md leading-relaxed">
            ...
            <div className="mt-4 flex w-full max-w-sm flex-col gap-3">
              <button className="w-full flex items-center justify-center gap-2 bg-gradient-to-br from-[var(--primary)] to-[var(--primary-container)] text-[var(--on-primary)] px-6 py-4 rounded-xl font-bold text-lg hover:brightness-110 active:scale-95 transition-all shadow-[0_0_20px_rgba(186,158,255,0.2)]">
                <Download className="w-5 h-5" /> Download on Google Play
              </button>
              <p className="text-xs text-[var(--on-surface-variant)] text-center">Available for Android 8.0+</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Simple Footer */}
      <footer className="w-full py-12 px-6 border-t border-[rgba(64,72,92,0.15)] bg-[var(--surface-container-lowest)]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <p className="text-sm text-[var(--on-surface-variant)] flex items-center gap-1">
            Built with <Heart className="w-3 h-3 text-[var(--tertiary)]" /> using Next.js & Tailwind V4
          </p>
        </div>
      </footer>
    </main>
